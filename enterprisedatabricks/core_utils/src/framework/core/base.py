...
class MedallionBase(ABC):
    ...
    def __init__(self, args):
        ...
        # Initialize Spark session, environment, audit logger, and config for the medallion layer
        ...
        self.config = ConfigManager.load_config(args=args)
    ...
    def run(self) -> None:
        ...
        validation, enrichment, or custom auditing logic. The base class
        does not provide a default so layers can override freely.
        """
        pass